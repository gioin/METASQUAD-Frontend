...
@section ('content')
    ...
    @endif
    <!-- Default box -->
    <form class="box" action="{{route('about.update')}}" method="post">
        @method('PUT')
        @csrf
        ...
        <div class="box-body">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab_1" data-toggle="tab"><img src="{{asset('administrator/images/en.png')}}" width="30"/> </a></li>
                </ul>
